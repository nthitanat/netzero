    ...
    const renderIcon = () => {
        ...
        switch (stateGoogleIcon.iconType) {
            ...
            case "monetization_on":
                return <span className={baseClass}>monetization_on</span>;
            case "payments":
                return <span className={baseClass}>payments</span>;
            case "local_atm":
                return <span className={baseClass}>local_atm</span>;
            case "attach_money":
                return <span className={baseClass}>attach_money</span>;
            ...
            case "swap_horiz":
                return <span className={baseClass}>swap_horiz</span>;
            case "volunteer_activism":
                return <span className={baseClass}>volunteer_activism</span>;
            case "home":
                return <span className={baseClass}>home</span>;
            case "favorite":
                return <span className={baseClass}>favorite</span>;
            case "redeem":
                return <span className={baseClass}>redeem</span>;
            case "card_giftcard":
                return <span className={baseClass}>card_giftcard</span>;
